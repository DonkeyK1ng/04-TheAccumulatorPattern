...
def run_test_count_sines_from():
    ...
    print('       actual:  ', answer)
    expected = 3
    answer1 = count_sines_from(4, 8)
    print('Test 2 expected :', expected)
    print('Test 2 actual: ', answer1)
    expected = 4
    answer2 = count_sines_from(6, 11)
    print('Test 3 expected :', expected)
    print('     actual', answer2)
    expected = 3

    print('Test 4Expected : ', expected)
    answer3 = count_sines_from(10, 12)
    print('actual,', answer3)

    expected = 59
    answer4 = count_sines_from(12, 100)
    print('Test 4 expected : ', expected)
    print('Actual  ', answer4)

    expected = 6
    answer5 = count_sines_from(1, 10)
