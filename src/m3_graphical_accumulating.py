...
def draw_parallel_lines(n, point, length, window):
    ...
    for k in range(4):
        point = rg.Point(x, y)
        line = rg.Line(rg.Point(50, 200 + (30 * k)), rg.Point(300, 200 + (30 * k)))
        line.attach_to(window)
        y = y - 30
    for k in range(7):
        point = rg.Point(x, y)
        line1 = rg.Line(rg.Point(400, 50+(30*k)), rg.Point(500, 50+(30*k)))
...
def draw_lines(n, point, window):
    ...
    for k in range(4):
        point=rg.Point(x,y)
        line=rg.Line(rg.Point(50,150),rg.Point(150,300-(80*k)))
